...
export function BrandXIcon({ className = "size-4 text-white" }: { className?: string }) {
  return (
...
export function BrandGithubIcon({ className = "size-4 text-white" }: { className?: string }) {
  return (
...
export function BrandLinkedinIcon({ className = "size-4 text-white" }: { className?: string }) {
  return (
...
export function BrandLinkedinIn({ className = "size-4.5 text-white" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-label="LinkedIn">
...
export function BrandCalIcon({ className = "w-5.5 h-auto text-white" }: { className?: string }) {
  return (
    <svg viewBox="0 8.5 24 6.5" fill="currentColor" className={className} aria-label="Cal.com">
...
export function BrandTelegramIcon({ className = "size-5" }: { className?: string }) {
  return (
...
export function BrandEmailIcon({ className = "size-4 text-zinc-200" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function BrandResumeIcon({ className = "size-4 text-zinc-200" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function BrandDiscordIcon({ className = "size-4 text-white" }: { className?: string }) {
  return (
